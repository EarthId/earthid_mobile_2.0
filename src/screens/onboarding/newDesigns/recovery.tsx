      ...
      <ScrollView contentContainerStyle={styles.sectionContainer}>
        ...
        <View style={styles.category}>
          <View>
            ...
            >
              Please select your cloud service provider to recover your data
            </GenericText>
            {/* <Button
              selected={false}
              disabled={false}
...
<View style={{ marginTop: -20 }}>
  <Button
    selected={false}
    disabled={false}
    onPress={() => navigation.navigate('GoogleDriveRestore')}
    style={{
      buttonContainer: {
        opacity: 1, backgroundColor: "#fff", elevation: 2,
        borderColor: Screens.colors.primary, iconStyle: Screens.colors.primary,
      },
    }}
    title="GOOGLE DRIVE"
  />
...
<View style={{ marginTop: -20 }}>
  <Button
    selected={false}
    disabled={false}
    onPress={() => navigation.navigate('DropboxRestore')}
    style={{
      buttonContainer: {
        opacity: 1, backgroundColor: "#fff", elevation: 2,
        borderColor: Screens.colors.primary, iconStyle: Screens.colors.primary,
